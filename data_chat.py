...
# Слой A. Все условия, правила, события, значения — здесь.
# Код других слоёв только реагирует. Никаких if в логике.
...
PROVIDERS = [
    ...
    {"id": "cerebras", "name": "Cerebras", "base_url": "https://api.cerebras.ai/v1",
     "models": ["llama3.3-70b"], "model_default": "llama3.3-70b",
     "priority": 3, "enabled": True, "keys": []},
    {"id": "sambanova", "name": "SambaNova", "base_url": "https://api.sambanova.ai/v1",
     "models": ["Meta-Llama-3.3-70B-Instruct"], "model_default": "Meta-Llama-3.3-70B-Instruct",
     "priority": 4, "enabled": True, "keys": []},
    {"id": "custom", "name": "Свой", "base_url": "", "models": [], "model_default": "",
     "priority": 5, "enabled": False, "keys": []},
]

# ================= ПРАВИЛА ОШИБОК =================
# Условие → действие. Код читает правило и применяет. Никаких if в других слоях.

ERROR_RULES = {
    429: {"action": "cooldown", "seconds": 60},
    401: {"action": "exhausted"},
    403: {"action": "exhausted"},
    "default": {"action": "cooldown", "seconds": 15},
}
...
PROMPTS = [
    {"id": "p_a_1", "slot": "layer_a", "name": "default", "text": "", "active": False, "slot_enabled": False},
    {"id": "p_b_1", "slot": "layer_b", "name": "default", "text": "", "active": False, "slot_enabled": False},
    {"id": "p_c_1", "slot": "layer_c", "name": "default", "text": "", "active": False, "slot_enabled": False},
    {"id": "p_d_1", "slot": "layer_d", "name": "default", "text": "", "active": False, "slot_enabled": False},
    {"id": "p_ac_1", "slot": "layer_a_content", "name": "base", "text": "", "active": False, "slot_enabled": False},
]
...
SETTINGS = {
    ...
    "stream": True, "autosave_enabled": True, "autosave_every_n": 20,
    "autoclean_mb": 4, "autoclean_days": 30,
}
...
<header><h1>AI Monolog Chat</h1><button class="copy" onclick="loadSnapshot()">обновить</button></header>
